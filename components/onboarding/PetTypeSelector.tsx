...
const PET_TYPES = [
    { id: 'dog', name: 'Dog', icon: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&q=80' },
    { id: 'cat', name: 'Cat', icon: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=400&q=80' },
