...
export function StatsOverlay({ isOpen, onClose, pet }: Props) {
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-2xl bg-card rounded-[2.5rem] border-2 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
                    >
                        {/* Header */}
                        <div className="p-8 border-b border-border/50 flex items-center justify-between bg-linear-to-r from-emerald-500/10 to-transparent">
